  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Container(
        ...
        child: Padding(
          padding: const EdgeInsets.symmetric(vertical: 18.0 , horizontal: 23),
          child: Column(
            children: [
              const Text('الشروط والأحكام' , style: Styles.textStyle20W500,),
              const SizedBox(
                height: 32,
              ),
              ...
              Row(
                ...
                children: [
                  Text('لقد قرأت جميع الشرط والأحكام وأوافق عليهم' , style: Styles.textStyle12W400.copyWith(color: AppColors.lightGrayColor),),
                  const SizedBox(
                    width: 18,
                  ),
                  InkWell(
