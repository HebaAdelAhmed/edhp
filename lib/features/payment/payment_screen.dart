          ...
          child: SingleChildScrollView(
            child: Column(
              children: [
                ...
                const Text('الدفع' , style: Styles.textStyle20W500,),
                SizedBox(
                ...
                Row(
                  children: [
                    ...
                    const Spacer(),
                    const Text('بطاقة إئتمان' , style: Styles.textStyle20W500,)
                  ],
                ),
                SizedBox(
                ...
                Row(
                  ...
                  children: [
                    Text('حفظ بيانات البطاقه' , style: Styles.textStyle14W400.copyWith(color: AppColors.lightGrayColor),),
                    const SizedBox(
                      width: 18,
                    ),
                    InkWell(
