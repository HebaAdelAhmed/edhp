      ...
      child: Column(
        children: [
          Padding(
            ...
            child: Text(name , style: Styles.textStyle16W500.copyWith(color: index % 2 ==0 ? AppColors.whiteColor : AppColors.blackColor),),
          ),
          Row(
          ...
          Text(description ?? '  ' ,  style: Styles.textStyle12W400.copyWith(color:  index % 2 == 0 ? AppColors.whiteColor : AppColors.blackColor),),
          SizedBox(
